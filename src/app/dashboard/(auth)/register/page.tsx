...
const Register = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const image: string = (e.currentTarget[1] as HTMLInputElement).value;
    const email: string = (e.currentTarget[2] as HTMLInputElement).value;
    const password: string = (e.currentTarget[3] as HTMLInputElement).value;
  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit} className={styles.form} autoComplete="off">
        ...
        <input type="text" placeholder="User Image" className={styles.input} />
